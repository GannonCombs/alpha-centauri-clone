        ...
        for event in pygame.event.get():
            ...
            if game is None:
                ...
                if intro_result == 'load_game':
                    ...
                    # Start new game with selected faction, name, ocean percentage, cloud cover, erosive forces, native life, and difficulty
                    _, faction_id, player_name, ocean_percentage, cloud_cover, erosive_forces, native_life, difficulty = intro_result
                    game = Game(faction_id, player_name, ocean_percentage, map_width, map_height, cloud_cover, erosive_forces, native_life, difficulty=difficulty)
                    renderer = Renderer(screen)
                    ui_panel = UIManager()
                    # Give game reference to UI for accessing design workshop
                    game.ui_manager = ui_panel
