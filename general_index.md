...
**unit.py**
Unit class for all mobile game entities. Supports land units, sea units, and air units. Handles movement points, terrain restrictions, turn resets, garrison status, and ownership tracking.
